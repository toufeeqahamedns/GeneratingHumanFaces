...
def parse_arguments():
    ...
    parser.add_argument("--generator_file", action="store", type=str,
                        default="/home/toufeeq/CollegeProject/BBMSG-GAN/sourcecode/models/1/GAN_GEN_1000.pth", help="path to the trained generator model")

    parser.add_argument("--depth", action="store", type=int,
                        default=9, help="Depth of the network")

    parser.add_argument("--latent_size", action="store", type=int,
                        default=512, help="Depth of the network")
...
def main(args):
    ...
    gen.load_state_dict(th.load(args.generator_file, map_location=str(device)), strict=False)
